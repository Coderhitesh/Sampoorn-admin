...
function EditTestimonial() {
    ...
    const handleFetchTestimonial = async () => {
        try {
            const { data } = await axios.get(`https://api.sampoornmarketing.com/api/v1/get-single-testimonial/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const res = await axios.put(`https://api.sampoornmarketing.com/api/v1/update-testimonial/${id}`, payload, {
